    ...
    def new_statement(self, operation):
        if isinstance(operation, str):
            if 'LIMIT' in operation: 
                operation = str(operation.replace('LIMIT 100001', '').replace('LIMIT 100000', '').replace('LIMIT 10001', '').replace('LIMIT 10000', '').replace('LIMIT 1001', '').replace('LIMIT 1000', '').replace('LIMIT 101', '').replace('LIMIT 100', '').replace('LIMIT 11', '').replace('LIMIT 10', '').strip())
                #with open(r"path to ...\www\superset\superset_config\test.txt", 'a', encoding="utf-8") as logs:
                #    logs.write(f"555 - 2 - 1 sqlanydb.py =========== {str(operation)}\n")
        self.free_statement()
    ...
    def executemany(self, operation, seq_of_parameters):
        if isinstance(operation, str):
            if 'LIMIT' in operation: 
                operation = str(operation.replace('LIMIT 100001', '').replace('LIMIT 100000', '').replace('LIMIT 10001', '').replace('LIMIT 10000', '').replace('LIMIT 1001', '').replace('LIMIT 1000', '').replace('LIMIT 101', '').replace('LIMIT 100', '').replace('LIMIT 11', '').replace('LIMIT 10', '').strip())
                #with open(r"path to ...\www\superset\superset_config\test.txt", 'a', encoding="utf-8") as logs:
                #    logs.write(f"555 - 3 - 1 sqlanydb.py =========== {str(operation)}\n")
        self.messages = []
        ...
        try:
            ...
            if isinstance(operation, str):
                if 'LIMIT' in operation: 
                    operation = str(operation.replace('LIMIT 100001', '').replace('LIMIT 100000', '').replace('LIMIT 10001', '').replace('LIMIT 10000', '').replace('LIMIT 1001', '').replace('LIMIT 1000', '').replace('LIMIT 101', '').replace('LIMIT 100', '').replace('LIMIT 11', '').replace('LIMIT 10', '').strip())
                    #with open(r"path to ...\www\superset\superset_config\test.txt", 'a', encoding="utf-8") as logs:
                    #    logs.write(f"555 - 4 - 1 sqlanydb.py =========== {str(operation)}\n")
        ...
        if operation:
            if isinstance(operation, str):
                if 'LIMIT' in operation: 
                    operation = str(operation.replace('LIMIT 100001', '').replace('LIMIT 100000', '').replace('LIMIT 10001', '').replace('LIMIT 10000', '').replace('LIMIT 1001', '').replace('LIMIT 1000', '').replace('LIMIT 101', '').replace('LIMIT 100', '').replace('LIMIT 11', '').replace('LIMIT 10', '').strip())
                    #with open(r"path to ...\www\superset\superset_config\test.txt", 'a', encoding="utf-8") as logs:
                    #    logs.write(f"555 - 1 - 1 sqlanydb.py =========== {str(operation)}\n")
                    #    logs.write(f"555 - 1 - 2 sqlanydb.py =========== {str(parameters)}\n")
